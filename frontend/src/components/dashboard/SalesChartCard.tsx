  ...
  return (
    <div className="rounded-[2rem] bg-white/90 p-4 sm:p-6 shadow-[0_18px_45px_rgba(15,23,42,0.06)]">
      ...
      <div className="mb-5 sm:mb-7 flex flex-row items-start justify-between gap-3">
        ...
        <button className="shrink-0 mt-1 rounded-2xl bg-[#f4f6fb] px-3 py-1.5 sm:px-4 sm:py-2 text-[10px] sm:text-xs font-bold uppercase tracking-[0.12em] text-slate-600 shadow-inner transition hover:bg-indigo-50 hover:text-indigo-700">
          Last 7 Days
        </button>
      </div>
      ...
      {points.length === 0 ? (
        ...
        <div className="relative rounded-[1.5rem] bg-gradient-to-b from-[#f8f9fd] to-white px-3 sm:px-5 pb-3 sm:pb-5 pt-4 sm:pt-6">
                ...
                >
                  ...
                  <div
                    className={[
                      ...
                      isLast
                        ? 'bg-gradient-to-t from-indigo-700 to-violet-500 shadow-[0_8px_18px_rgba(79,70,229,0.28)]'
                  ...
                  {/* Label */}
                  <span className={`text-[9px] sm:text-[10px] lg:text-[11px] font-bold uppercase tracking-[0.14em] ${isLast ? 'text-indigo-700' : 'text-slate-500'}`}>
                    {point.label}
                  </span>
                </div>
              )
